...
If you want to install it yourself via docker or singularity follow the instructions on the [github page](https://github.com/Gaius-Augustus/Augustus). If you lack the tools or necessary permission, it is also possible to setup Augustus via conda — cloning the repo like this will get you whatever is on the default branch at the time you run it, not a pinned version:
