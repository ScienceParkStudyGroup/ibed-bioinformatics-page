...
If you want to install it yourself, the command below installs the version verified on Crunchomics. Before running it, check the [SingleM documentation](https://wwood.github.io/singlem/) for a newer version and swap the version number if one is available.
