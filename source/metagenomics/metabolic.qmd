...
If you want to install it yourself, you can run the commands below — cloning the repo like this will get you whatever is on the default branch at the time you run it, not a pinned version.
