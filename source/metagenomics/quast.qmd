...
If you want to install it yourself, the command below installs the version verified on Crunchomics. Before running it, check [the manual](https://quast.sourceforge.net/docs/manual.html#sec1) for a newer version and swap the version number if one is available.
