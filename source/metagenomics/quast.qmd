...
Installed on crunchomics: Yes, Quast v5.2.0 is installed as part of the bioinformatics share. If you have access to crunchomics you can be added to the bioinformatics share by sending an email with your Uva netID to [Nina Dombrowski](n.dombrowski@uva.nl). Afterwards, you can add the conda environments that are installed in the bioinformatics conda share as follows:
