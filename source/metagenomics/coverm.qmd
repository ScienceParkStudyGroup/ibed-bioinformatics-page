...
If you want to install it yourself, the command below installs the version verified on Crunchomics. Before running it, check the tool's [GitHub](https://github.com/wwood/CoverM) for a newer version and swap the version number if one is available.
