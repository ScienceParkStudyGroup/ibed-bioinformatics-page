...
If you want to install it yourself, the command below installs the version verified on Crunchomics. Before running it, check the tool's [Bitbucket page](https://bitbucket.org/berkeleylab/metabat/src/master/) for a newer version and swap the version number if one is available.
