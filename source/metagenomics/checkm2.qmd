...
For more information, check out the tools [github page](https://github.com/chklovski/CheckM2).
...
If you want to install it yourself, the command below installs the version verified on Crunchomics. Before running it, check the [GitHub](https://github.com/chklovski/CheckM2) for a newer version and swap the version number if one is available.

```{bash}
mamba create -n checkm2_1.1.0 -c bioconda -c conda-forge checkm2=1.1.0
