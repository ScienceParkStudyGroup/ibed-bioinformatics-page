...
If you want to install it yourself, the command below installs the version verified on Crunchomics. Before running it, check the tool's [Gitlab](https://gitlab.com/ezlab/busco) for a newer version and swap the version number if one is available.
