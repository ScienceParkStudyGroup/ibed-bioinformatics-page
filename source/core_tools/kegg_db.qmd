...
For a detailed example on how to use this database, you can have a look at the section "Compare proteins of interest against a hmm database" on this [page](https://scienceparkstudygroup.github.io/ibed-bioinformatics-page/source/core_tools/hmmer.html).