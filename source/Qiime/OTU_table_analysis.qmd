...
df <- cbind(as.data.frame(as(tax_table(physeq_rel_abundance)[as.character(wilcox_results$OTU), ], "matrix")),as.data.frame(as(otu_table(physeq_rel_abundance)[as.character(wilcox_results$OTU), ], "matrix")))
