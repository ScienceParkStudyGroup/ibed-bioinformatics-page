...
Therefore, I recommend to read carefully to read through the [How it works section](https://github.com/rrwick/Porechop) of the softwares manual to know what to expect and look out for. 

Similarly, porechop works with both demultiplexed and non-demultiplexed sequences.
:::
