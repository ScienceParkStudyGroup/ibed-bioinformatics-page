...
If you want to install it yourself, you can run the following to install the tool from source — cloning the repo like this will get you whatever is on the default branch at the time you run it, not a pinned version.
