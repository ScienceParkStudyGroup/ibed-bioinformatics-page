...
def main():
    ...
    parser.add_argument("-g", "--genes", help="Text file containing protein IDs for genes of interest (one gene per line). This setting is optional", default=None)
    ...
    # tRNA
    # trna_track = sector.add_track((71, 78), r_pad_ratio=0.1)
