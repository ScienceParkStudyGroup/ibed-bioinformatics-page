...
-   [Using the local scratch on Crunchomics](source/cli/scratch.qmd)
...
- [Custom scripts](source/core_tools/custom_scripts.qmd): A list of custom scripts useful for bioinformatic analyses
...
- [Bash input validation](source/core_tools/bash-input-validation.qmd ): How do I check in my Bash scripts whether inputs already exist and avoid re-running tools?
- [Bash arrays](source/core_tools/bash-arrays.qmd ): Arrays in bash — and when you don't need them
- [Bash pipefails](source/core_tools/bash-pipefail.qmd): Telling a Bash script how to deal with exit codes
...
- [arCOG](source/core_tools/arcog.qmd): Archaeal Clusters of Orthologous Genes (arCOGs) database to analyse archaea
- [COG](source/core_tools/cog.qmd): Cluster of Orthologous Genes (COGs) to analyse bacteria
- [dbCAN](source/core_tools/dbcan.qmd): Database to analyse carbohydrate-active enzymes in genomes
- [FeGenie](source/core_tools/fegenie.qmd): Database to identify iron genes and iron operons in genomes
- [HydDB](source/core_tools/hyddb.qmd): Database to identify hydrogenases in genomes
- [KOfam](source/core_tools/kegg_db.qmd): Database to assign KEGG orthologous (KOs) to protein sequences
- [NCBI-nr](source/core_tools/ncbi_nr.qmd): NCBI's non-redundant (nr) protein database to analyse protein sequences
- [Pfam](source/core_tools/pfam_db.qmd): A collection of protein models to analyse protein sequences
- [PGAP database](source/core_tools/pgap_db.qmd): Successor to the TIGRFAM database
- [TIGRFAM](source/core_tools/tigrfam_db.qmd): A collection of manually curated protein families to analyse prokaryotic sequences


## Bioinformatic tools A-Z

<details class="tool-az">
<summary>A-D</summary>
  <ul>
    ...
    <li><a href="source/metagenomics/binette.qmd">Binette</a>: A tool to generate a non-redundant bin set</li>
    ...
    <li><a href="source/core_tools/bwa.qmd">BWA</a>: A tool to map DNA sequences against a large reference genome</li>
    ...
    <li><a href="source/metagenomics/comebin.qmd">COMEBin</a>: A tool for reconstructing genomes from metagenomic data</li>
    ...
    <li><a href="source/metagenomics/dastool.qmd">DAS Tool</a>: A tool to generate a non-redundant bin set</li>
...
<summary>E-H</summary>
  <ul>
    ...
    <li><a href="source/nanopore/fastplong.qmd">fastplong</a>: A tool for ultrafast preprocessing and quality control for long reads </li>
    ...
    <li><a href="source/core_tools/fegenie.qmd">FeGenie</a>: A HMM-based identification and categorization of iron genes</li>
...
<summary>M-P</summary>
  <ul>
    ...
    <li><a href="source/metagenomics/metabat2.qmd">MetaBAT2</a>: A tool for reconstructing genomes from metagenomic data</li>
...
<summary>Q-Z</summary>
  <ul>
    ...
    <li><a href="source/metagenomics/semibin.qmd">SemiBin2</a>: A tool for reconstructing genomes from metagenomic data</li>
    ...
    <li><a href="source/metagenomics/vamb.qmd">VAMB</a>: A tool for reconstructing genomes from metagenomic data</li>
  </ul>
</details>
