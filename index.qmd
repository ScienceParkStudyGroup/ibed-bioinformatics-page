...
-   [MultiQC](source/metagenomics/multiqc.qmd): A program to summarize analysis reports
...
-   [Ribodetector](source/metatranscriptomics/ribodetector.qmd): Detect and remove rRNA sequences from metagenomic, metatranscriptomic, and ncRNA sequencing data
...
-   [Star](source/metatranscriptomics/star.qmd): An ultrafast universal RNA-seq aligner
-   [Trycyler](source/metagenomics/trycycler.qmd): A tool for generating consensus long-read assemblies for bacterial genomes
